	...
	$inputForm.validate({
		rules: {
			NAME: {
				required: true,
				remote: {
					url: "<%=basePath%>hslgpage/platform/ad/profile/check_extra_name.do?ID=${row.ID}",
					cache: false
				}
			},
			PICTURE: "required",
	...
	<form id="inputForm" action="update.do" method="post">
		<table class="input">
			...
			<tr>
				...
				<td>
					<select id="page" name="page" style="width:190px;" maxlength="200" >
						<c:choose>
							<c:when test="${row.PAGE ==1}">
			...
			<tr>
				...
				<td>
					...
					<img src="${row.PICTURE}" style="width:200px;height:200px;" id="sumbImg"/>
				</td>
			</tr>
			<tr>
				<th>
