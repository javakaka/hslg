			...
			<tr>
				...
				<td>
					<select id="TYPE_ID" name="TYPE_ID" style="width:190px;" maxlength="200" >
						<c:choose>
							<c:when test="${row.TYPE_ID == 1}">
							<option value="" >请选择...</option>
								<option value="1" selected>开锁服务</option>
								<option value="2" >快递</option>
								<option value="3" >家电维修</option>
								<option value="4" >家政保洁</option>
							</c:when>
							<c:when test="${row.TYPE_ID == 2}">
								<option value="" >请选择...</option>
							...
							<c:when test="${row.TYPE_ID == 3}">
								<option value="" >请选择...</option>
								<option value="1" >开锁服务</option>
								<option value="2" >快递</option>
								<option value="3" selected>家电维修</option>
								<option value="4" >家政保洁</option>
							</c:when>
							<c:when test="${row.TYPE_ID == 4}">
								<option value="" >请选择...</option>
								<option value="1" >开锁服务</option>
								<option value="2" >快递</option>
								<option value="3" >家电维修</option>
								<option value="4" selected>家政保洁</option>
							</c:when>
							<c:otherwise>
