	...
	<form id="listForm" action="list.do" method="get">
			...
			<div class="menuWrap">
				...
				<div class="popupMenu">
					<ul id="searchPropertyOption">
						<li>
							<a href="javascript:;" <c:if test="${page.searchProperty == 'NAME'}"> class="current"</c:if> val="NAME">标题</a>
						</li>
						<li>
							<a href="javascript:;" <c:if test="${page.searchProperty == 'TYPE_NAME'}"> class="current"</c:if> val="TYPE_NAME">分类</a>
						</li>
					</ul>
				</div>
			</div>
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="LINK_TEL">联系人电话</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="ICON_URL">图片</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="VIEW_NUM">浏览次数</a>
				</th>
				<th>
			...
			<c:forEach items="${page.content}" var="row" varStatus="status">
				<tr>
					...
					<td>
						<img src="<%=imgBasePath%>${row.ICON_URL}" alt="${row.NAME}" style="width:50px;height:50px;" />
					</td>
					<td>
