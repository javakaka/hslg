	...
	<form id="listForm" action="list.do" method="get">
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="NUM">捐款次数</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="MONEY">捐款金额</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="REMARK">简介</a>
				</th>
				<th>
			...
			<c:forEach items="${page.content}" var="row" varStatus="status">
				<tr>
					...
					<td>
						<span title="${row.DONATION_MONEY}">${row.REMARK}</span>
					</td>
					<td>
