...
function confirm()
{
		var server_url ="<%=basePath%>hslgpage/platform/version/copyVersionFile.do";
		//id=1;
		var params ={id:id,deal_type:deal_type,type:type,sub_type:sub_type};
		//alert(params);
		$.ajax({url: "<%=basePath%>hslgpage/platform/version/copyVersionFile.do",
				type: "POST",
				data: params,
				dataType: "json",
				cache: false,
